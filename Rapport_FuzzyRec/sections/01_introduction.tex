...
La problematique etudiee dans ce rapport est la suivante : comment representer et traiter computationnellement l'imprecision intrinseque des preferences utilisateur afin de produire des recommandations interpretable et reproductibles ? Cette question est directement liee au sujet 12 du cours de Logique Floue en Intelligence Artificielle \cite{kasereka2026}, qui demande de concevoir un systeme de recommandation flou base sur les preferences imprecises des utilisateurs.
