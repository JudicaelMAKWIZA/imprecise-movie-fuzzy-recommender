...
class PreferencesEditor:
    ...
    `Sci-Fi=0.9,Action=0.7`. Cela suffit pour une demonstration de soutenance
    sans ajouter de dependance graphique lourde.
    """

    def __init__(self, parent: tk.Widget, default_text: str = "Sci-Fi=0.9,Action=0.7") -> None:
        self.parent = parent
    ...
    def get_preferences(self) -> dict[str, float]:
        """Parser la saisie en preferences numeriques."""
