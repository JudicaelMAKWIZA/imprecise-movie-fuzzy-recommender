...
def generate_mamdani_example(context):
    ...
    figure.tight_layout()
    figure.savefig(FIGURES / "exemple_inference_mamdani.png", dpi=180, bbox_inches="tight")
    plt.close(figure)
...
def generate_cli_capture() -> None:
    ...
    figure.savefig(FIGURES / "cli_recommend.png", dpi=180, bbox_inches="tight", facecolor=figure.get_facecolor())
    plt.close(figure)


def generate_gui_captures(_has_recommendation: bool) -> None:
    root = tk.Tk()
    root.geometry("1040x760+80+80")
